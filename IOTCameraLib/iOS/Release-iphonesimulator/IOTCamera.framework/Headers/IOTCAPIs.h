...
*
* \details This function is for a client to to get a free session ID used for a parameter of
 ...
 * \attention Only use to stop IOTC_Connect_ByUID() not IOTC_Connect_ByUID_Parallel()
 */
